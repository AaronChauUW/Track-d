...
public class CustomNavigationAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public CustomNavigationAdapter(Activity a, String[] data, Resources res) {
        this.activity = a;
        this.data = data;
        this.res = res;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            customView = inflater.inflate(R.layout.custom_navigation_list_item, null);
